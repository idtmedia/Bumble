    ...
    <div class="advert-manage-item <?php echo 'advert-item advert-item-col-'.(int)$columns ?>">
        ...
        <div class="advert-published adverts-manage-actions-wrap">
            ...
            <span class="adverts-manage-actions-left">
                ...
                <a href="<?php echo get_site_url().'/my-dashboard/?alsp_action=my_classifieds&advert_id=' . get_the_ID(); ?>" title="<?php _e("Edit", "adverts") ?>" class="adverts-manage-action"><span class="adverts-icon-pencil-squared"></span><?php _e("Edit", "adverts") ?></a>
