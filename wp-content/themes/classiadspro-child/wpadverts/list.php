    ...
    <form action="<?php echo esc_attr( $action ) ?>" class="adverts-search-form" method="get">
        ...
        <div class="adverts-search">
            <?php foreach( $fields_visible as $field ): ?>
                <?php if($field['name']=='location') continue; ?>
        ...
        <?php /*<div class="adverts-options-left adverts-js">
            <?php if($switch_views): ?>
        ...
        <div class="adverts-options-right">
            <a href="<?php echo get_site_url(); ?>/classified/add" class="cz-submit-btn btn btn-primary post-an-ad">Post an Item</a>
        </div>
