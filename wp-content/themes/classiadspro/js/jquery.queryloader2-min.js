...
function pacz_query_loader() {

    if (pacz_detect_ie() == false) {
         $("body").queryLoader2({
            showbar: "on",
            barColor: pacz_preloader_bar_color,
            textColor: pacz_preloader_txt_color,
            backgroundColor: pacz_preloader_bg_color,
            barHeight: 2,
			logo: pacz_preloader_logo,
            percentage: false,
            completeAnimation: "fade",
            minimumTime: 700,
            onComplete: function() {
                $(".pacz-body-loader-overlay").fadeOut(600, "easeInOutExpo", function() {
                    $(this).remove();
                });
            }
        });
