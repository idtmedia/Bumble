...
*/
class Classiadspro_Widget_Social extends WP_Widget {
	...
	function __construct() {
		...
		WP_Widget::__construct( 'social', PACZ_THEME_SLUG.' - '.'Social Networks', $widget_ops );
			...
			foreach ( $instance['enable_sites'] as $site ) {
				$link = isset( $instance[strtolower( $site )] )?$instance[strtolower( $site )]:'#';
					//if($site == 'vimeo' || $site == 'spotify') {
						//$site_class = 'pacz-theme-icon-social-'.$site;
					//} else {
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'align' ); ?>"><?php _e('Align:', 'classiadspro'); ?></label>
		...
		<div id="pacz-social-custom-skin">

			<p>
				<label for="<?php echo $this->get_field_id( 'icon_color' ); ?>"><?php _e('Icon Color:', 'classiadspro'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_hover_color' ); ?>"><?php _e('Icon Hover Color:', 'classiadspro'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_border_color' ); ?>"><?php _e('Icon Border Color:', 'classiadspro'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_bg_main_color' ); ?>"><?php _e('Icon Background Color:', 'classiadspro'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'icon_bg_color' ); ?>"><?php _e('Icon Hover Background Color:', 'classiadspro'); ?></label>
