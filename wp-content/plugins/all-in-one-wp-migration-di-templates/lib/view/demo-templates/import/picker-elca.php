<div id="ai1wmdi-import-modal-elca" class="ai1wmdi-modal ai1wm-not-visible">
	<div class="ai1wm-modal-action">
		...
		<p>
			...
			<button type="button" class="ai1wmdi-import-url-elca ai1wm-button-green" id="ai1wmdi-import-url-elca" value="https://assets.designinvento.net/classiads-auth/files/classiads-elca.wpress" v-on="click: select" /><?php _e( 'Confirm', AI1WMDI_PLUGIN_NAME ); ?></button>
