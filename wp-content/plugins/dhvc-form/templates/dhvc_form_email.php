...
global $dhvc_form;
$default_value = apply_filters('dhvc_form_email_default_value', $default_value,$dhvc_form,$name);
$label = $control_label;
...
$output .= '<input data-field-name="'.$name.'" autocomplete="off" type="email" id="dhvc_form_control_'.$name.'" name="'.$name.'" value="'.$default_value.'" '.(!empty($maxlength) ? ' maxlength="'.$maxlength.'"' : '')
