...
<div class="alsp-submit-listing-wrap row clearfix">
	<div class="cz-creat-listing col-md-8 col-sm-12 col-xs-12">
		<div class="cz-creat-listing-inner clearfix">
			...
			<h2><?php echo sprintf(apply_filters('alsp_create_option', __('Create new listing in level "%s"', 'ALSP'), $alsp_instance->current_listing), $alsp_instance->current_listing->level->name); ?></h2>
			<?php endif; ?>
