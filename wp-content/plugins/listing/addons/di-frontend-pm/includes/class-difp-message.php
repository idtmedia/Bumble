...
//$author_name = get_the_author_meta('display_name', $authorID);
		...
		break;
		case 'author' :
			?><span class="difp-message-author"><?php the_author_meta('display_name'); ?></span><span class="difp-message-date"><?php the_time(); ?></span><?php
		break;
		case 'title' :
			...
			$width= 60;
				...
				<span class="<?php echo $class; ?>"><a href="<?php echo difp_query_url('viewmessage', array('difp_id'=> get_the_ID())); ?>"><?php the_title();?></a></span><?php echo $span; ?><?php echo $bid_wrap ?><?php
		break;
		default:
