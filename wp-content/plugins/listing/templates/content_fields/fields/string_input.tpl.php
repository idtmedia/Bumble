<div class="alsp-field alsp-field-input-block alsp-field-input-block-<?php echo $content_field->id; ?>">
	...
	<div class="text-string-input">
		<input type="text" name="alsp-field-input-<?php echo $content_field->id; ?>" class="alsp-field-input-string form-control" value="<?php echo esc_attr($content_field->value); ?>" />
