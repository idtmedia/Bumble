...
<?php $max_value = (($search_field->min_max_value['max']) ? $search_field->min_max_value['max'] : __('max', 'ALSP')); ?>
<?php endif; ?>
<?php if($price_col == 3){$pricecol = 3;} ?>
<?php 
$gap_in_fields = $ALSP_ADIMN_SETTINGS['gap_in_fields']; 
...
?>
<div class="czprice-slider search-element-col alsp-field-search-block-<?php echo $search_field->content_field->id; ?> alsp-field-search-block-<?php echo $random_id; ?> alsp-field-search-block-<?php echo $index; ?> pull-left" style=" width:<?php echo $field_width ?>%; padding:0 <?php echo $gap_in_fields; ?>px;">
	<div class="col-md-12">
	...
	<div class="col-md-12 alsp-jquery-ui-slider">
