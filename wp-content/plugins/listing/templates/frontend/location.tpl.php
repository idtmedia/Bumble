...
<?php global $ALSP_ADIMN_SETTINGS; ?>
		<div class="listings location-archive">
			...
			<?php alsp_renderSubLocations(get_query_var('location-alsp'), $ALSP_ADIMN_SETTINGS['alsp_locations_columns'], $ALSP_ADIMN_SETTINGS['alsp_show_location_count']); ?>

				<?php if (term_description($frontend_controller->location->term_id, ALSP_LOCATIONS_TAX)): ?>
				<div class="archive-meta"><?php echo term_description($frontend_controller->location->term_id, ALSP_LOCATIONS_TAX); ?></div>
				<?php endif; ?>
